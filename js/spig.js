...
jQuery(document).ready(function ($) {
    $("#spig").mousedown(function (e) {
        ...
        showMessage("天气播报<iframe name=\"xidie\" src=\"http://t.xidie.com/skin/2012-0226.html\"frameborder=\“0\” scrolling=\"no\" height=\"50px\"  width=\"200px\" allowtransparency=\"true\" ></iframe>" +
                    "</br>秘密通道:<br /><a href=\"http://www.lostscroll.com\" title=\"濯桑首页\">濯桑首页</a>",10000);
}
});
...
jQuery(document).ready(function ($) {
    if (isindex) { //如果是主页
        ...
        showMessage('欢迎' + visitor + '来到濯桑听《' + title + '》', 6000);
    }
    $(".spig").animate({
...
jQuery(document).ready(function ($) {
    ...
    window.setInterval(function () {
        msgs = ["天气播报<iframe name=\"xidie\" src=\"http://t.xidie.com/skin/2012-0226.html\"frameborder=\“0\” scrolling=\"no\" height=\"40px\"  width=\"200px\" allowtransparency=\"true\" ></iframe>", 
        "陪我聊天吧！", "", "好无聊哦，你都不陪我玩！", "…@……!………", "^%#&*!@*(&#)(!)(", "我可爱吧！嘻嘻!~^_^!~~","你是我的小呀小苹果~~","从前有座山，山上有座庙，庙里有个老和尚给小和尚讲故事，讲：“从前有座……”"];
        var i = Math.floor(Math.random() * msgs.length);
